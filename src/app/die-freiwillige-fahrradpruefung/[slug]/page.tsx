...
export default function VerkehrDetailPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  const resolvedParams = use(params);
  const topic = verkehrTopics[resolvedParams.slug];
    ...
    <div className="site-wrapper">
      ...
      <main className="content-container">
        ...
        <div className="breadcrumb-nav">
          ...
          <span>/</span>
          <Link href="/die-freiwillige-fahrradpruefung">Fahrradprüfung & Verkehr</Link>
          <span>/</span>
        ...
        {topic.keyPoints.length > 0 && (
          <div className="topic-rules-card">
            <h2>Wichtige Verkehrsregeln & Merksätze</h2>
        ...
        {topic.worksheetLink && (
          <div className="eduki-box-card">
            <div className="eduki-box-content">
              ...
              <p>
                Bereite dich optimal auf die Fahrradprüfung vor mit Arbeitsblättern und Tests zu <strong>{topic.title}</strong> auf Eduki.
              </p>
            </div>
            <a
