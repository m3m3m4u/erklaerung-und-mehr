      ...
      <main className="content-container">
        ...
        <section className="math-intro-banner">
          <div className="math-intro-content">
            ...
            <p className="math-page-note">
              Mit interaktiven H5P-Übungen zur optimalen Vorbereitung auf die schulische Radfahrprüfung.
            </p>
          </div>
          <div className="image-placeholder math-mascot">
            <span>[Fahrradprüfung & Verkehr]</span>
          </div>
        </section>
        ...
        >
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center' }}>
            <input
              type="text"
              placeholder="🔍 Thema oder Regel suchen..."
              value={searchQuery}
