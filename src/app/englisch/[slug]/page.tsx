...
import { englischTopics } from '@/lib/englisch-data';
import H5PPlayer, { XAPIStatement } from '@/components/H5PPlayer';
import MathText from '@/components/MathText';
import Header from '@/components/Header';
import Footer from '@/components/Footer';

export default function EnglischDetailPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  const resolvedParams = use(params);
  const topic = englischTopics[resolvedParams.slug];
    ...
    <div className="site-wrapper">
      ...
      <main className="content-container">
        ...
        <div className="breadcrumb-nav">
          ...
          <span>/</span>
          <Link href="/englisch">Englisch</Link>
          <span>/</span>
        ...
        {topic.keyPoints.length > 0 && (
          <div className="topic-rules-card">
            <h2>Grammar Rules, Signal Words and Key Points</h2>
        ...
        <section className="topic-exercises-section">
          <h2 className="section-main-heading">Interactive Exercises ({topic.exercises.length})</h2>
        ...
        <section className="info-box-section" style={{ marginTop: '40px' }}>
          <h3>Worksheets & English Practice</h3>
          <p>
            Passend zu <strong>{topic.title}</strong> gibt es auf EDUKI vertiefende Kopiervorlagen, Tests und Arbeitsblätter zum Download.
          </p>
          <a
            href={topic.worksheetLink || `https://eduki.com/de/autor/1430402/about-the-world-org?query=${encodeURIComponent(topic.title)}+english&t=468`}
            target="_blank"
