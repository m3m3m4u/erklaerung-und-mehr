...
export default function HauswirtschaftDetailPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  const resolvedParams = use(params);
  const topic = hauswirtschaftTopics[resolvedParams.slug];
    ...
    <div className="site-wrapper">
      ...
      <main className="content-container">
        ...
        <div className="breadcrumb-nav">
          ...
          <span>/</span>
          <Link href="/hauswirtschaft">Hauswirtschaft</Link>
          <span>/</span>
        ...
        {topic.keyPoints.length > 0 && (
          <div className="topic-rules-card">
            <h2>Wichtige Grundlagen & Merksätze</h2>
        ...
        {topic.worksheetLink && (
          <div className="eduki-box-card">
            <div className="eduki-box-content">
              ...
              <p>
                Vertiefe dein hauswirtschaftliches Alltagswissen mit Arbeitsblättern und Praxisübungen zu <strong>{topic.title}</strong> auf Eduki.
              </p>
            </div>
            <a
