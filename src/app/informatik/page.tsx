      ...
      <main className="content-container">
        ...
        <section className="math-intro-banner">
          <div className="math-intro-content">
            <h1 className="math-page-title">Informatik & Digitale Grundbildung</h1>
            <p className="math-page-desc">
              Die Welt von heute ist digital – ohne IT und Internet geht nichts mehr!
              Hier lernst du alles über Computer-Hardware, Netzwerke, Betriebssysteme,
        ...
        >
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center' }}>
            <input
              type="text"
              placeholder="🔍 Thema suchen (z. B. Hardware, IP-Adresse, Trojaner, HTML, Turing, CPU...)"
              value={searchQuery}
        ...
        {filteredTopics.length === 0 ? (
          ...
          informatikCategories.map((categoryName) => {
        ...
        <section className="info-box-section" style={{ marginTop: '40px' }}>
          ...
          <p>
            Zu allen Themen der Informatik und Digitalen Grundbildung findest du auf EDUKI passende
            Kopiervorlagen, Tests und Arbeitshefte zum Download.
          </p>
          <a
            href="https://eduki.com/de/autor/1430402/erklaerung-und-mehr-org?query=&t=896"
            target="_blank"
            rel="noopener noreferrer"
            className="button-link"
            style={{ marginTop: '8px' }}
          >
            Zu den Informatik-Materialien auf EDUKI
          </a>
        </section>
      </main>
