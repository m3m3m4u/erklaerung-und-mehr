      ...
      <main className="content-container">
        ...
        <section className="math-intro-banner">
          <div className="math-intro-content">
            <h1 className="math-page-title">Religion</h1>
            ...
            <p className="math-page-note">
              Mit verständlichen Einführungen, Kernfakten und interaktiven H5P-Übungen.
            </p>
          </div>
        ...
        {
          religionCategories.map((categoryName) => {
        ...
        <section className="info-box-section" style={{ marginTop: '40px' }}>
          <h3>Arbeitsblätter & Religionsunterricht-Materialien</h3>
          <p>
            Zu allen Themen des evangelischen und katholischen Religionsunterrichts, Weltreligionen und biblischen Geschichten findest du auf EDUKI passende Kopiervorlagen, Stundenentwürfe und Tests zum Download.
          </p>
          <a
            href="https://eduki.com/de/autor/1430402/about-the-world-org?query=religion&t=3752"
            target="_blank"
            rel="noopener noreferrer"
            className="button-link"
            style={{ marginTop: '8px' }}
          >
            Zu den Religion-Materialien auf EDUKI
          </a>
        </section>
      </main>

      <Footer activePath="/religion" />
    </div>
  );
}
