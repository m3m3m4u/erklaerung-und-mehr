...
export default function KlimaDetailPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  const resolvedParams = use(params);
  const topic = klimaTopics[resolvedParams.slug];
    ...
    <div className="site-wrapper">
      ...
      <main className="content-container">
        ...
        <div className="breadcrumb-nav">
          ...
          <span>/</span>
          <Link href="/sustainable-development-goals">Klima, Umwelt & SDGs</Link>
          <span>/</span>
        ...
        {topic.keyPoints.length > 0 && (
          <div className="topic-rules-card">
            <h2>Wichtige Ziele, Fakten und Handlungsfelder</h2>
        ...
        <section className="info-box-section" style={{ marginTop: '40px' }}>
          ...
          <p>
            Passend zu <strong>{topic.title}</strong> gibt es auf EDUKI vertiefende Kopiervorlagen, Stationenarbeiten und strukturierte Arbeitshefte zum Download.
          </p>
          <a
            href={topic.worksheetLink || `https://eduki.com/de/autor/1430402/about-the-world-org?query=${encodeURIComponent(topic.title)}+sdg&t=3752`}
            target="_blank"
